...
// 		$groupusers['group-1'] = getSubByKey( $mutualusers , 'fid');
	...
	{	
		...
		$d['source_url'] = urldecode($_POST['source_url']);  //应用分享到活动，原资源链接
		// 滤掉话题两端的空白
	...
	/**
	 * 分享/转发活动操作，需要传入POST的值
	 * @return json 分享/转发活动后的结果信息JSON数据
	 */
